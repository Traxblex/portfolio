...
<head>
  ...
  <title>projet Details - ALLAMA Bootstrap Template</title>
  ...
  <!-- =======================================================
  * Template Name: ALLAMA
  * Template URL: https://bootstrapmade.com/ALLAMA-bootstrap-projet-website-template/
...
<body class="projet-details-page">
          ...
          <div class="col-lg-6" data-aos="fade-right">
            <div class="projet-details-media">
              <div class="main-image">
                <div class="projet-details-slider swiper init-swiper" data-aos="zoom-in">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="assets/img/projet/projet-5.webp" alt="projet Image" class="img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/img/projet/projet-7.webp" alt="projet Image" class="img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="assets/img/projet/projet-8.webp" alt="projet Image" class="img-fluid">
                    </div>
                  </div>
              ...
              <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
                <div class="row g-2 mt-3">
                  <div class="col-3">
                    <img src="assets/img/projet/projet-4.webp" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="assets/img/projet/projet-6.webp" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="assets/img/projet/projet-11.webp" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="assets/img/projet/projet-12.webp" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <div class="projet-details-content">
              ...
              <div class="project-overview">
                ...
                <div class="accordion project-accordion" id="projet-details-projectAccordion">
                  <div class="accordion-item" data-aos="fade-up">
                    <h2 class="accordion-header">
                      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#projet-details-collapse-1" aria-expanded="true" aria-controls="collapseOne">
                        <i class="bi bi-clipboard-data me-2"></i> Project Overview
                      </button>
                    </h2>
                    <div id="projet-details-collapse-1" class="accordion-collapse collapse show" data-bs-parent="#projet-details-projectAccordion">
                  ...
                  <div class="accordion-item" data-aos="fade-up" data-aos-delay="100">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#projet-details-collapse-2" aria-expanded="false" aria-controls="collapseTwo">
                        <i class="bi bi-exclamation-diamond me-2"></i> The Challenge
                      </button>
                    </h2>
                    <div id="projet-details-collapse-2" class="accordion-collapse collapse" data-bs-parent="#projet-details-projectAccordion">
                      <div class="accordion-body">
                  ...
                  <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#projet-details-collapse-3" aria-expanded="false" aria-controls="collapseThree">
                        <i class="bi bi-award me-2"></i> The Solution
                      </button>
                    </h2>
                    <div id="projet-details-collapse-3" class="accordion-collapse collapse" data-bs-parent="#projet-details-projectAccordion">
                      <div class="accordion-body">
